...
/**
 * This is a special type of order that is sent to a customer automatically as separate order when they place
 * a regular order on their birthday
 * @author Rich
 *
 */
public class BirthdayOrder extends Order{
  static List<Product> birthdayProducts = new ArrayList<>(Arrays.asList(new SimpleChocolateBox(), new SimpleFlowerArrangement()));
